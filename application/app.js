...
jQuery(function() {
    ...
    function open_options() {
        ...
        focused = 0;
        document.getElementById("options-" + document.activeElement.getAttribute("data-slug")).style.display = "block"
        document.getElementById("options-" + document.activeElement.getAttribute("data-slug")).children[0].focus()
